...
var btnactivate = "HERE";
var urlactivate = "YOURURL";
var messageerror = "Message of Activation";
 ...
 $("#activeblog").text() != q && $("body").html('<div class="jojo99"><div id="no-active"></div>'+ messageerror +'<a href='+ urlactivate +'> '+btnactivate+'</a></div>');
