...
if(commenttext=='1 تعليق')commenttext='1 تعليق';if(commenttext=='0 تعليقات')commenttext='لا يوجد تعليقات';commenttext='<a href="'+commenturl+'" target ="_top">'+commenttext+'</a>';towrite=towrite+commenttext;flag=1;;}
if(displaymore==true)
