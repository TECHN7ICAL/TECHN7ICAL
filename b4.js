...
function createCookie(name, value, days) {
    ...
    //document.cookie = name+"="+value+expires+"; path=/; domain=.picalica.com <http://picalica.com>";
...
$(document).ready(function() {
    $('#pagepiling').pagepiling({
        ...
        navigation: {
            ...
            'bulletsColor': '#c49b66',
            'position': 'right',
            'tooltips': ['Macit', 'About Me', 'Skills', 'Portfolio', 'Contact Me']
        },
...
function PathController(count) {
  ...
  const MIN_LENGTH = CANVAS_HEIGHT + 324;
...
function Path() {
  ...
  this.minLength = CANVAS_HEIGHT + 1012;
